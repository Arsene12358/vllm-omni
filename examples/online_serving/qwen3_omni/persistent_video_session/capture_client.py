...
BRIEF = ("You are a video understanding assistant. Answer in exactly two short sentences: "
...
async def main() -> int:
    ...
    async with websockets.connect(uri, max_size=64 * 1024 * 1024) as ws:
        await ws.send(json.dumps({
            ...
            "persistent": True, "sink_frames": SINK, "num_frames": RECENT,
            "refresh_at_position": REFRESH_AT, "enable_frame_filter": False,
            "system_prompt": BRIEF,
        }))
